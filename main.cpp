...
//
//        if (seqnum_new != seqmum_old + 1)
//        {
//			//std::cout << "丢失了:" << seqnum_new - seqmum_old - 1 << "个数据包" << std::endl;
//            lost_cnt += seqnum_new - seqmum_old - 1;
//            std::cout<<"丢包率: " << static_cast<float>(lost_cnt) / seqnum_new << std::endl;
//		}
//
//        // 获取数据
...
//
//            // 更新
//            seqmum_old = seqnum_new;
//            bytenum_old = bytenum_new;
//
//        }
//    }
//}
